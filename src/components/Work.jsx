...
const Work = () => {
    ...
    var images = [
        ...
        {url: "https://cdn.prod.website-files.com/6334198f239547d0f9cd84b3/634ef092455ce2cf591e52d1_Rainfall.png", top: "51%", left: "49%", isActive: false},
        ...
        {url: "https://cdn.prod.website-files.com/6334198f239547d0f9cd84b3/634ef0af108a465002975acd_Showcase%20Websites%20(1).png", top: "60%", left: "65%", isActive: false},
    ]
        ...
        <div className='relative max-w-screen-xl mx-auto text-center'>
            ...
            <div className="absolute top-0 w-full h-full">
                {images.map((elem, index) => {
                    return <img key={index} className="absolute w-60 rounded-lg  -translate-x-[50%] -translate-y-[50%] " src={elem.url}
                    style={{top: elem.top}}
                    alt="" />
                })}
            </div>
